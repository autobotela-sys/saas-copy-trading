      ...
      <div className="flex h-screen w-full overflow-hidden">
        ...
        <div className="hidden lg:flex flex-col justify-center items-center w-1/2 bg-background-dark text-white p-12 relative overflow-hidden">
          ...
          <div className="relative z-10 max-w-lg">
            ...
            <h2 className="text-4xl font-bold leading-tight mb-6">Start your trading journey today.</h2>
            <p className="text-lg text-slate-400 mb-8 leading-relaxed">
              Join thousands of traders using our platform to synchronize strategies across multiple broker accounts.
            </p>
          </div>
        </div>
        ...
        <div className="w-full lg:w-1/2 flex flex-col justify-center items-center bg-background-light dark:bg-background-dark px-6 py-12">
          <div className="w-full max-w-[440px] flex flex-col gap-8">
            <div className="flex flex-col gap-2">
              ...
              <p className="text-slate-500 dark:text-slate-400">Sign up to get started with copy trading.</p>
            </div>
